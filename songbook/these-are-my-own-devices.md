...
original_title: Left To My Own Devices
...
Read all the news about the IoT,
 Turns out that ten point three can cause connection dropping,

I update my phone, my tablet and my car,
...
Running updates, constantly,
On my laptop, my TV, and my phone,
But these are my own devices,
So leave them alone

Buy a new game, time to have some fun,
The only catch is there’s a ten gig patch,
I’d like to wait, but it’s a forced update,
...
Yes, my grades were a mess, but on the B B S,
I was always online, I was system admin,
...
Do we delay the release, and risk the shareholder's rage?
But in the back of my head, I knew the bugs could wait,
We can deal with them later in an app update…
...
Who cares if the code is looking five by five,
